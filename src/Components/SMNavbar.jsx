...
import sellHolder from "../Icons/SellHolder.svg"
import sellPlus from "../Icons/SellPlus.svg"
			...
			<header>
				<div id="iconHolder">
					<a href="/" className="iconLink">
						<svg height="22" viewBox="0 0 36.289 20.768" alt="Logo" className="blueOlx">
					...
					<a className="iconLink" href="/">
						<svg xmlns="http://www.w3.org/2000/svg" width="88.9" height="33" alt="OLX Motors" className="headerLink">
							<defs>
				...
				<div id="searchbar">
					<a href="/">
						<svg viewBox="0 0 36.289 20.768" alt="Logo" height="35">
							<path d="M18.9 20.77V0h4.93v20.77zM0 10.39a8.56 8.56 0 1 1 8.56 8.56A8.56 8.56 0 0 1 0 10.4zm5.97-.01a2.6 2.6 0 1 0 2.6-2.6 2.6 2.6 0 0 0-2.6 2.6zm27 5.2l-1.88-1.87-1.87 1.88H25.9V12.3l1.9-1.9-1.9-1.89V5.18h3.27l1.92 1.92 1.93-1.92h3.27v3.33l-1.9 1.9 1.9 1.9v3.27z">
							</path>
						</svg>
					</a>
					...
					<div className="search" style={{ position: 'relative' }}>
						...
						<div className="searchIcon">
							<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 1024 1024" class="_4743d0f8">
					...
					<div id="sellBtn">
						<img src={sellHolder} alt="" />
						<div className="sellText">
							<img src={sellPlus} alt="" />
							<span>SELL</span>
						</div>
					</div>
				</div>
			</header>
			<div id="navlinkHolder">
				<div>
					<div className="navlink mainNavlink">All Categories<img src={arrow} alt="" /></div>
					<div className="navlink hovLink">Mobile Phones</div>
					<div className="navlink hovLink">Cars</div>
					<div className="navlink hovLink">Motorcycles</div>
					<div className="navlink hovLink">Houses</div>
					<div className="navlink hovLink">TV-Video-Audio</div>
					<div className="navlink hovLink">Tablets</div>
					<div className="navlink hovLink">Land & Plots</div>
				</div>
			</div>
		</>
	)
